...
import { WorkDTO, getWorksListingAction, updateWorkAction } from "@/actions/mla/works";
...
export default function WorksListingClient({
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : "Failed to fetch works";
      setError(errorMsg);
  ...
  const handleTableChange = async (pagination: any) => {
    ...
    setLoading(true);
    setError("");
    console.log("Fetching page:", pagination.current);
