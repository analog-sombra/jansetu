    ...
    <div>
      ...
      >
        <Row style={{ height: "100%", overflow: "hidden" }} gutter={16}>
          ...
          <Col xs={24} sm={24} md={6} style={{ paddingRight: 16, paddingLeft: 16, paddingTop: 16, overflow: "auto", maxHeight: "calc(70vh - 100px)" }}>
            <div style={{ backgroundColor: "#f9fafb", padding: 12, borderRadius: 4, position: "sticky", top: 0 }}>
              ...
              <div style={{ fontSize: 11, lineHeight: 1.8 }}>
                ...
                <div style={{ marginBottom: 8 }}>
                  ...
                  <br />
                  <Text>{Math.floor((selectedEscalation?.ageHours ?? 0) / 24)} days</Text>
                </div>
                <div style={{ marginBottom: 8 }}>
                  <Text strong>Status:</Text>
                  <br />
                  <Tag color={STATUS_COLORS[selectedEscalation?.status ?? "ASSIGNED"]}>
                    {(selectedEscalation?.status ?? "ASSIGNED").replaceAll("_", " ")}
                  </Tag>
                </div>
              </div>
              <div style={{ marginTop: 16, padding: "8px 12px", backgroundColor: "#fef3c7", borderRadius: 4, borderLeft: "4px solid #f59e0b" }}>
                <Text type="warning" style={{ fontSize: 11 }}>
                  ✓ This is an auto-drafted notice. Edit the letter content on the right as needed.
                </Text>
              </div>
            </div>
          </Col>
          ...
          <Col xs={24} sm={24} md={18} style={{ paddingRight: 16, paddingTop: 16, overflow: "hidden", maxHeight: "calc(70vh - 100px)", display: "flex", flexDirection: "column" }}>
