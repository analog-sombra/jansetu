                ...
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={filteredWards}>
                      ...
                      <YAxis domain={[0, 100]} />
                      <Tooltip
                        formatter={(value) => [`${value ?? 0}%`, t("report.resolutionRate")]}
                      />
                        ...
                        >
                          ...
                          <Space orientation="vertical" size={6} style={{ width: "100%" }}>
                            ...
                            <Progress
                              ...
                              size="small"
                              format={() => `${resolutionRate}% ${t("report.resolved")}`}
                            />
                            <Text type="secondary" style={{ fontSize: 12 }}>
                              {t("report.avgResolution")}: {item.avgResolutionDays} {t("report.days")} |{" "}
                  ...
                  <Col xs={24} md={8} key={item.key}>
                    ...
                    >
                      <Space orientation="vertical" size={4} style={{ width: "100%" }}>
                        ...
                        <Text>
                          {t("report.activeCluster")}: <strong>{item.activeCases}</strong>{" "}
                          {t("report.grievances")}
                        </Text>
                ...
                {isMounted ? (
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Tooltip
                        formatter={(value) => [`${value ?? 0}%`, t("report.netScore")]}
                      />
                      <Legend />
                    </PieChart>
                  </ResponsiveContainer>
                  ...
                  <Col span={12}>
                    ...
                    >
                      ...
                      <Text style={{ color: "rgba(255,255,255,0.8)" }}>
                        {t("report.resolvedOn")} {new Date(item.resolvedAt).toLocaleDateString("en-IN")}
                      </Text>
                    </div>
                  </Col>
                </Row>
